...
const AboutPage = () => {
  ...
  const bio = documentToReactComponents(data.contentfulAboutPage.bioText.json, options)
  const valueStatement = documentToReactComponents(data.contentfulAboutPage.valueStatement.json, options)
